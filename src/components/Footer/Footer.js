    ...
    render() {
        const MyMapComponent = withScriptjs(withGoogleMap((props) =>
            <GoogleMap
                ...
                {props.isMarkerShown && <Marker position={{ lat: 52.4232, lng:16.9100 }} icon={{ url:"https://www.laco.eu/wp-content/themes/laco/assets/img/icons/google-maps-icons/icon-map-marker.svg", scaledSize: new window.google.maps.Size(25, 25)}} />}
            </GoogleMap>
        ))
        return (
            ...
            <div className={"footer__wrap"}>
                ...
                <section className={"footer__box"}>
                    ...
                    <div className={"footer__box__localisation"}>
                        <div>
                            ...
                            <MyMapComponent
                                isMarkerShown
                                googleMapURL="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=geometry,drawing,places&key=AIzaSyD6UHgXkEQ7OCCxVPWs7AQghxucXnfVoGk"
                                loadingElement={<div  />}
                ...
                <div className={"footer__author"}><div>Projekt i realizacja: Nazwa</div>
                </div>
            </div>
        )
    }
