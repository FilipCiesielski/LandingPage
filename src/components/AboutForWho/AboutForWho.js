                ...
                <section className={"about1__box"}>
                    <div className={"about1__box__article"}>
                        ...
                        <p>Lorem ipsum dolor sit amet quam. Phasellus in augue turpis, accumsan tincidunt.
                            ...
                            lorem, iaculis scelerisqueiaculis scelerisque iaculis scelerisque. Duis vel metus. Donec
                            mauris rhoncus eget, dui. Suspendisse
                            justo iaculis augue. Duis luctus, nisl sit amet augue id sapien. Pellentesque habitant morbi
                            tristique in, ipsum. Fusce suscipit sed, dui. In neque
                            lorem, iaculis scelerisque. Duis vel metus. Donec adipiscing elit.
                            Sed pulvinar risus. Sed sit amet, consectetuer <a href={""} target={"_blank"}> (felis
                                non)</a>.</p>
                    ...
                    <div className={"about1__box__media"}>
                        <div className={"about1__box__media--image"}>
                            <img alt="globe in hand"
                                 src={"https://image.freepik.com/free-photo/close-up-hand-holding-globe_23-2147817185.jpg"}>
                            </img>
                        </div>
